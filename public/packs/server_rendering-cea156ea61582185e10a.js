...
throw new Error("Module build failed: SyntaxError: Expected corresponding JSX closing tag for <hr> (38:7)\n\n  36 | \t\t\t\t\t\t\t\t<a class=\"active\" href=\"#home\">HOME</a>    \n  37 | \t\t\t\t\t\t\t\t<hr class=\"style-two\">\n> 38 | \t\t\t\t\t\t\t</div>\n     | \t\t\t\t\t\t\t^\n  39 | \t\t\t\t\t</div>\n  40 | \t\t)\n  41 | \t}\n");
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-cea156ea61582185e10a.js.map