...
var Header = function (_React$Component) {
	...
	_createClass(Header, [{
		...
		value: function render() {
			return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
				"div",
				{ id: "header", "class": "header-wrapper" },
			...
			_createClass(Footer, [{
						...
						value: function render() {
									return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
												'p',
												null,
												'Using React Inside Your Rails Apps Last updated: 2017-05-31 by Leigh Halliday | 12 Comments Development Reading Time: 10 minutes I have never felt as productive as I do in Rails. Yet, with front-end seemingly moving further away from server-rendered views toward React, Angular, Vue, and Ember, I was unsure where Rails fit into this picture. Would it be relegated only to apps with \u201Csimple\u201D front-ends, where holding things together with jQuery still managed to work, or perhaps to its new API mode, serving up data via RESTful JSON feeds to be consumed by client-side code and mobile apps? The answer to that question may be yes, because Rails still does an amazing job at that. But perhaps the answer lies more in the realm of \u201Cmaybe\u2026it depends\u201D. Would it be better to bring the best of the front-end and have it live happily within the Rails ecosystem? In this article, Marian Serna and I will explore different ways of using React inside of your new or existing Rails apps. \u201CExplore different ways to use React inside your new or existing Rails apps.\u201D via @leighchalliday Click To Tweet Rails Embraces JavaScript JavaScript has its flaws and that\u2019s why Rails embraced CoffeeScript early on instead of plain JS. With ES6 and Babel, CoffeeScript seemed less and less necessary, and in fact to me became something I disliked writing when most examples and articles online were using ES6 syntax. The js2coffee website came in handy to convert between the two syntaxes. Then came the issue of how to include JS libraries in your Rails app. The typical way would be to look for a \u201CRails\u201D version of the JS library on rubygems.org, or perhaps take advantage of rails-assets.org. It was a good solution for the time, but to fully embrace JS and provide a more seamless integration, we needed the ability to have a package.json file to list our JS dependencies, install them via yarn, and Using React Inside Your Rails Apps Last updated: 2017-05-31 by Leigh Halliday | 12 Comments Development Reading Time: 10 minutes I have never felt as productive as I do in Rails. Yet, with front-end seemingly moving further away from server-rendered views toward React, Angular, Vue, and Ember, I was unsure where Rails fit into this picture. Would it be relegated only to apps with \u201Csimple\u201D front-ends, where holding things together with jQuery still managed to work, or perhaps to its new API mode, serving up data via RESTful JSON feeds to be consumed by client-side code and mobile apps? The answer to that question may be yes, because Rails still does an amazing job at that. But perhaps the answer lies more in the realm of \u201Cmaybe\u2026it depends\u201D. Would it be better to bring the best of the front-end and have it live happily within the Rails ecosystem? In this article, Marian Serna and I will explore different ways of using React inside of your new or existing Rails apps. \u201CExplore different ways to use React inside your new or existing Rails apps.\u201D via @leighchalliday Click To Tweet Rails Embraces JavaScript JavaScript has its flaws and that\u2019s why Rails embraced CoffeeScript early on instead of plain JS. With ES6 and Babel, CoffeeScript seemed less and less necessary, and in fact to me became something I disliked writing when most examples and articles online were using ES6 syntax. The js2coffee website came in handy to convert between the two syntaxes. Then came the issue of how to include JS libraries in your Rails app. The typical way would be to look for a \u201CRails\u201D version of the JS library on rubygems.org, or perhaps take advantage of rails-assets.org. It was a good solution for the time, but to fully embrace JS and provide a more seamless integration, we needed the ability to have a package.json file to list our JS dependencies, install them via yarn, andUsing React Inside Your Rails Apps Last updated: 2017-05-31 by Leigh Halliday | 12 Comments Development Reading Time: 10 minutes I have never felt as productive as I do in Rails. Yet, with front-end seemingly moving further away from server-rendered views toward React, Angular, Vue, and Ember, I was unsure where Rails fit into this picture. Would it be relegated only to apps with \u201Csimple\u201D front-ends, where holding things together with jQuery still managed to work, or perhaps to its new API mode, serving up data via RESTful JSON feeds to be consumed by client-side code and mobile apps? The answer to that question may be yes, because Rails still does an amazing job at that. But perhaps the answer lies more in the realm of \u201Cmaybe\u2026it depends\u201D. Would it be better to bring the best of the front-end and have it live happily within the Rails ecosystem? In this article, Marian Serna and I will explore different ways of using React inside of your new or existing Rails apps. \u201CExplore different ways to use React inside your new or existing Rails apps.\u201D via @leighchalliday Click To Tweet Rails Embraces JavaScript JavaScript has its flaws and that\u2019s why Rails embraced CoffeeScript early on instead of plain JS. With ES6 and Babel, CoffeeScript seemed less and less necessary, and in fact to me became something I disliked writing when most examples and articles online were using ES6 syntax. The js2coffee website came in handy to convert between the two syntaxes. Then came the issue of how to include JS libraries in your Rails app. The typical way would be to look for a \u201CRails\u201D version of the JS library on rubygems.org, or perhaps take advantage of rails-assets.org. It was a good solution for the time, but to fully embrace JS and provide a more seamless integration, we needed the ability to have a package.json file to list our JS dependencies, install them via yarn, andUsing React Inside Your Rails Apps Last updated: 2017-05-31 by Leigh Halliday | 12 Comments Development Reading Time: 10 minutes I have never felt as productive as I do in Rails. Yet, with front-end seemingly moving further away from server-rendered views toward React, Angular, Vue, and Ember, I was unsure where Rails fit into this picture. Would it be relegated only to apps with \u201Csimple\u201D front-ends, where holding things together with jQuery still managed to work, or perhaps to its new API mode, serving up data via RESTful JSON feeds to be consumed by client-side code and mobile apps? The answer to that question may be yes, because Rails still does an amazing job at that. But perhaps the answer lies more in the realm of \u201Cmaybe\u2026it depends\u201D. Would it be better to bring the best of the front-end and have it live happily within the Rails ecosystem? In this article, Marian Serna and I will explore different ways of using React inside of your new or existing Rails apps. \u201CExplore different ways to use React inside your new or existing Rails apps.\u201D via @leighchalliday Click To Tweet Rails Embraces JavaScript JavaScript has its flaws and that\u2019s why Rails embraced CoffeeScript early on instead of plain JS. With ES6 and Babel, CoffeeScript seemed less and less necessary, and in fact to me became something I disliked writing when most examples and articles online were using ES6 syntax. The js2coffee website came in handy to convert between the two syntaxes. Then came the issue of how to include JS libraries in your Rails app. The typical way would be to look for a \u201CRails\u201D version of the JS library on rubygems.org, or perhaps take advantage of rails-assets.org. It was a good solution for the time, but to fully embrace JS and provide a more seamless integration, we needed the ability to have a package.json file to list our JS dependencies, install them via yarn, andUsing React Inside Your Rails Apps Last updated: 2017-05-31 by Leigh Halliday | 12 Comments Development Reading Time: 10 minutes I have never felt as productive as I do in Rails. Yet, with front-end seemingly moving further away from server-rendered views toward React, Angular, Vue, and Ember, I was unsure where Rails fit into this picture. Would it be relegated only to apps with \u201Csimple\u201D front-ends, where holding things together with jQuery still managed to work, or perhaps to its new API mode, serving up data via RESTful JSON feeds to be consumed by client-side code and mobile apps? The answer to that question may be yes, because Rails still does an amazing job at that. But perhaps the answer lies more in the realm of \u201Cmaybe\u2026it depends\u201D. Would it be better to bring the best of the front-end and have it live happily within the Rails ecosystem? In this article, Marian Serna and I will explore different ways of using React inside of your new or existing Rails apps. \u201CExplore different ways to use React inside your new or existing Rails apps.\u201D via @leighchalliday Click To Tweet Rails Embraces JavaScript JavaScript has its flaws and that\u2019s why Rails embraced CoffeeScript early on instead of plain JS. With ES6 and Babel, CoffeeScript seemed less and less necessary, and in fact to me became something I disliked writing when most examples and articles online were using ES6 syntax. The js2coffee website came in handy to convert between the two syntaxes. Then came the issue of how to include JS libraries in your Rails app. The typical way would be to look for a \u201CRails\u201D version of the JS library on rubygems.org, or perhaps take advantage of rails-assets.org. It was a good solution for the time, but to fully embrace JS and provide a more seamless integration, we needed the ability to have a package.json file to list our JS dependencies, install them via yarn, andUsing React Inside Your Rails Apps Last updated: 2017-05-31 by Leigh Halliday | 12 Comments Development Reading Time: 10 minutes I have never felt as productive as I do in Rails. Yet, with front-end seemingly moving further away from server-rendered views toward React, Angular, Vue, and Ember, I was unsure where Rails fit into this picture. Would it be relegated only to apps with \u201Csimple\u201D front-ends, where holding things together with jQuery still managed to work, or perhaps to its new API mode, serving up data via RESTful JSON feeds to be consumed by client-side code and mobile apps? The answer to that question may be yes, because Rails still does an amazing job at that. But perhaps the answer lies more in the realm of \u201Cmaybe\u2026it depends\u201D. Would it be better to bring the best of the front-end and have it live happily within the Rails ecosystem? In this article, Marian Serna and I will explore different ways of using React inside of your new or existing Rails apps. \u201CExplore different ways to use React inside your new or existing Rails apps.\u201D via @leighchalliday Click To Tweet Rails Embraces JavaScript JavaScript has its flaws and that\u2019s why Rails embraced CoffeeScript early on instead of plain JS. With ES6 and Babel, CoffeeScript seemed less and less necessary, and in fact to me became something I disliked writing when most examples and articles online were using ES6 syntax. The js2coffee website came in handy to convert between the two syntaxes. Then came the issue of how to include JS libraries in your Rails app. The typical way would be to look for a \u201CRails\u201D version of the JS library on rubygems.org, or perhaps take advantage of rails-assets.org. It was a good solution for the time, but to fully embrace JS and provide a more seamless integration, we needed the ability to have a package.json file to list our JS dependencies, install them via yarn, andUsing React Inside Your Rails Apps Last updated: 2017-05-31 by Leigh Halliday | 12 Comments Development Reading Time: 10 minutes I have never felt as productive as I do in Rails. Yet, with front-end seemingly moving further away from server-rendered views toward React, Angular, Vue, and Ember, I was unsure where Rails fit into this picture. Would it be relegated only to apps with \u201Csimple\u201D front-ends, where holding things together with jQuery still managed to work, or perhaps to its new API mode, serving up data via RESTful JSON feeds to be consumed by client-side code and mobile apps? The answer to that question may be yes, because Rails still does an amazing job at that. But perhaps the answer lies more in the realm of \u201Cmaybe\u2026it depends\u201D. Would it be better to bring the best of the front-end and have it live happily within the Rails ecosystem? In this article, Marian Serna and I will explore different ways of using React inside of your new or existing Rails apps. \u201CExplore different ways to use React inside your new or existing Rails apps.\u201D via @leighchalliday Click To Tweet Rails Embraces JavaScript JavaScript has its flaws and that\u2019s why Rails embraced CoffeeScript early on instead of plain JS. With ES6 and Babel, CoffeeScript seemed less and less necessary, and in fact to me became something I disliked writing when most examples and articles online were using ES6 syntax. The js2coffee website came in handy to convert between the two syntaxes. Then came the issue of how to include JS libraries in your Rails app. The typical way would be to look for a \u201CRails\u201D version of the JS library on rubygems.org, or perhaps take advantage of rails-assets.org. It was a good solution for the time, but to fully embrace JS and provide a more seamless integration, we needed the ability to have a package.json file to list our JS dependencies, install them via yarn, andUsing React Inside Your Rails Apps Last updated: 2017-05-31 by Leigh Halliday | 12 Comments Development Reading Time: 10 minutes I have never felt as productive as I do in Rails. Yet, with front-end seemingly moving further away from server-rendered views toward React, Angular, Vue, and Ember, I was unsure where Rails fit into this picture. Would it be relegated only to apps with \u201Csimple\u201D front-ends, where holding things together with jQuery still managed to work, or perhaps to its new API mode, serving up data via RESTful JSON feeds to be consumed by client-side code and mobile apps? The answer to that question may be yes, because Rails still does an amazing job at that. But perhaps the answer lies more in the realm of \u201Cmaybe\u2026it depends\u201D. Would it be better to bring the best of the front-end and have it live happily within the Rails ecosystem? In this article, Marian Serna and I will explore different ways of using React inside of your new or existing Rails apps. \u201CExplore different ways to use React inside your new or existing Rails apps.\u201D via @leighchalliday Click To Tweet Rails Embraces JavaScript JavaScript has its flaws and that\u2019s why Rails embraced CoffeeScript early on instead of plain JS. With ES6 and Babel, CoffeeScript seemed less and less necessary, and in fact to me became something I disliked writing when most examples and articles online were using ES6 syntax. The js2coffee website came in handy to convert between the two syntaxes. Then came the issue of how to include JS libraries in your Rails app. The typical way would be to look for a \u201CRails\u201D version of the JS library on rubygems.org, or perhaps take advantage of rails-assets.org. It was a good solution for the time, but to fully embrace JS and provide a more seamless integration, we needed the ability to have a package.json file to list our JS dependencies, install them via yarn, andUsing React Inside Your Rails Apps Last updated: 2017-05-31 by Leigh Halliday | 12 Comments Development Reading Time: 10 minutes I have never felt as productive as I do in Rails. Yet, with front-end seemingly moving further away from server-rendered views toward React, Angular, Vue, and Ember, I was unsure where Rails fit into this picture. Would it be relegated only to apps with \u201Csimple\u201D front-ends, where holding things together with jQuery still managed to work, or perhaps to its new API mode, serving up data via RESTful JSON feeds to be consumed by client-side code and mobile apps? The answer to that question may be yes, because Rails still does an amazing job at that. But perhaps the answer lies more in the realm of \u201Cmaybe\u2026it depends\u201D. Would it be better to bring the best of the front-end and have it live happily within the Rails ecosystem? In this article, Marian Serna and I will explore different ways of using React inside of your new or existing Rails apps. \u201CExplore different ways to use React inside your new or existing Rails apps.\u201D via @leighchalliday Click To Tweet Rails Embraces JavaScript JavaScript has its flaws and that\u2019s why Rails embraced CoffeeScript early on instead of plain JS. With ES6 and Babel, CoffeeScript seemed less and less necessary, and in fact to me became something I disliked writing when most examples and articles online were using ES6 syntax. The js2coffee website came in handy to convert between the two syntaxes. Then came the issue of how to include JS libraries in your Rails app. The typical way would be to look for a \u201CRails\u201D version of the JS library on rubygems.org, or perhaps take advantage of rails-assets.org. It was a good solution for the time, but to fully embrace JS and provide a more seamless integration, we needed the ability to have a package.json file to list our JS dependencies, install them via yarn, andUsing React Inside Your Rails Apps Last updated: 2017-05-31 by Leigh Halliday | 12 Comments Development Reading Time: 10 minutes I have never felt as productive as I do in Rails. Yet, with front-end seemingly moving further away from server-rendered views toward React, Angular, Vue, and Ember, I was unsure where Rails fit into this picture. Would it be relegated only to apps with \u201Csimple\u201D front-ends, where holding things together with jQuery still managed to work, or perhaps to its new API mode, serving up data via RESTful JSON feeds to be consumed by client-side code and mobile apps? The answer to that question may be yes, because Rails still does an amazing job at that. But perhaps the answer lies more in the realm of \u201Cmaybe\u2026it depends\u201D. Would it be better to bring the best of the front-end and have it live happily within the Rails ecosystem? In this article, Marian Serna and I will explore different ways of using React inside of your new or existing Rails apps. \u201CExplore different ways to use React inside your new or existing Rails apps.\u201D via @leighchalliday Click To Tweet Rails Embraces JavaScript JavaScript has its flaws and that\u2019s why Rails embraced CoffeeScript early on instead of plain JS. With ES6 and Babel, CoffeeScript seemed less and less necessary, and in fact to me became something I disliked writing when most examples and articles online were using ES6 syntax. The js2coffee website came in handy to convert between the two syntaxes. Then came the issue of how to include JS libraries in your Rails app. The typical way would be to look for a \u201CRails\u201D version of the JS library on rubygems.org, or perhaps take advantage of rails-assets.org. It was a good solution for the time, but to fully embrace JS and provide a more seamless integration, we needed the ability to have a package.json file to list our JS dependencies, install them via yarn, and'
									);
						}
			}]);
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-15c57095c3e58be83f8b.js.map